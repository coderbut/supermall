<template>
  <tab-bar>
    <tab-bar-item path="/home" active-color="#ff5a79">
    ...
    <tab-bar-item path="/category" active-color="#ff5a79">
    ...
    <tab-bar-item path="cart" active-color="#ff5a79">
    ...
    <tab-bar-item path="profile" active-color="#ff5a79">
